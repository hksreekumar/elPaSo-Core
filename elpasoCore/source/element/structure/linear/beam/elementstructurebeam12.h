...
#ifndef INFAM_ELEMENT_STRUCTURE_BEAM_12_H
#define INFAM_ELEMENT_STRUCTURE_BEAM_12_H

#include "elementstructurebeam3d.h"

//! @brief 3D Bernoulli beam element with 2 nodes
...
//! beam.
class cElementStructureBeam12 : public cElementStructureBeam3D,
                                private tCounter<cElementStructureBeam12> {
 private:
 ...
 public:
  //! @brief Constructor
  cElementStructureBeam12(const eUseBeamTheory &Theory = Bernoulli);
  //! @brief Copy constructor
  cElementStructureBeam12(const cElementStructureBeam12 &other);
  //! @brief Destructor
  ~cElementStructureBeam12();

  //! @brief return the number of instances of this object type
  static size_t howMany(void) {
    return tCounter<cElementStructureBeam12>::howMany();
  }
