...
#ifndef INFAM_NCELEMENTINTERFACE_H
#define INFAM_NCELEMENTINTERFACE_H

#include "../../material/fluid/materialfluid.h"
#include "../element.h"

//! @brief simple structure that holds all information used to setup an
//! nc interfaceelement. Adapted from elementinterface.h
//! @author Yannik Hüpel
//! @date 17.11.2021
typedef struct {
...
inline std::ostream &operator<<(std::ostream &os,
                                const sNCElementInterface &other) {
  std::string strTyp;
...
//! Adapted from elementinterface.h
//! @author Yannik Hüpel
//! @date 17.11.2021
class cNCElementInterface : public cElement,
                            private tCounter<cNCElementInterface> {
 private:
 ...
 protected:
  ...
  virtual void addContribution(Mat &A, Mat &B, const PetscScalar &factorC,
                               const PetscScalar &factorCT, int step) = 0;
 ...
 public:
  //! @brief Constructor
  cNCElementInterface(short NumberOfNodes);
  //! @brief Copy constructor
  cNCElementInterface(const cNCElementInterface &other);
  //! @brief Destructor
  ~cNCElementInterface();
  ...
  static size_t howMany(void) {
    return tCounter<cNCElementInterface>::howMany();
  }
...
inline std::ostream &write(std::ostream &os, const cNCElementInterface &other) {
