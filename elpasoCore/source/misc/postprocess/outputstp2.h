...
#ifndef INFAM_OUTPUTSTP2_H
#define INFAM_OUTPUTSTP2_H
...
class cOutputSTP2 : public cOutputfile, public cFilter {
 private:
  ...
  void writeResultSTP2(const int &step, const double &frequenz,
                       const std::string &Filename);

 public:
  cOutputSTP2();
  cOutputSTP2(cOutputSTP2 &other);
  ~cOutputSTP2();
